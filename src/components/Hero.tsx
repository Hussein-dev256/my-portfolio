            ...
            <div className="relative grid gap-7 pb-8 pt-5 sm:pb-10 sm:pt-7 lg:grid-cols-[360px_minmax(0,1fr)] xl:grid-cols-[390px_minmax(0,1fr)] lg:items-center lg:gap-8 xl:gap-12 lg:pb-6 lg:pt-2">
              ...
              >
                <div className="relative flex h-[440px] sm:h-[480px] lg:h-[390px] xl:h-[420px] w-full items-end justify-center">
                  ...
                  <div className="absolute left-2 top-2.5 z-20 flex items-center gap-2 rounded-full border border-white/80 bg-gradient-to-r from-white/85 via-white/60 to-white/75 px-3.5 py-1.5 sm:px-4 sm:py-2 text-neutral-950 backdrop-blur-2xl backdrop-saturate-150 shadow-[0_8px_20px_rgba(0,0,0,0.08),inset_0_1.5px_1px_rgba(255,255,255,1)] sm:left-3 sm:top-3">
